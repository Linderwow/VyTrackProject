...
public class TopMenuNew {
    ...
    @FindBy (xpath = "//a[@title ='Create Calendar event']")public WebElement createCalendarBtn;
    @FindBy (xpath = "(//input[@type ='checkbox'])[2] ") public  WebElement repeatBox;
    @FindBy (xpath = "(//input[@value ='1'])[2]") public WebElement repeatWindow;
    @FindBy (xpath = "(//span[* ='The value have not to be more than 99.'])[2]/span") public WebElement warning;
    @FindBy (xpath = "(//span[* ='The value have not to be less than 1.'])[2]") public WebElement negativeWarning;
